...
export const projects: Project[] = [
  {
    ...
    status: 'completed',
    highlights: ['基于 51 单片机，C 语言编程实现', '多种 LED 显示模式（流水、呼吸、闪烁等）', '掌握 GPIO 控制、定时器中断、按键消抖', '独立完成从编程到烧录调试的完整流程'],
  },
  {
    id: 'smart-desk-lamp',
    title: '智能台灯系统',
    ...
    status: 'completed',
    highlights: ['基于 STM32 主控，光敏传感器自动检测环境光', 'OLED 实时显示光照值与阈值，支持按键调节', '担任硬件电路负责人，完成原理图设计与 BOM 管理', '设计主控电路、电源管理、传感器接口及 LED 驱动电路', '从需求分析到硬件落地的全流程实践'],
  },
  {
    ...
    status: 'completed',
    highlights: ['完成电路搭建与元器件焊接', '熟练使用示波器、万用表等测试仪器', '掌握硬件故障排查与调试方法', '顺利通过课程验收'],
  },
  {
