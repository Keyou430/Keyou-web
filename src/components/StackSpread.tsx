...
const CARDS: SpreadCard[] = [
  { src: STACK_SRC[0], alt: 'Colour stripes', stackOffset: { x: -8, y: -10 }, stackRotate: -18,
    target: { x: -20, y: -34, rotate: 0, scale: SCALE[8], w: 17, h: 22 },
    targetSm: { x: -22, y: -40 }, z: 2 },
  { src: STACK_SRC[1], alt: 'Wildflower meadow', stackOffset: { x: 14, y: -10 }, stackRotate: 20,
    target: { x: 32, y: -30, rotate: 0, scale: SCALE[7], w: 18, h: 32 },
    targetSm: { x: 22, y: -40 }, z: 3 },
  { src: STACK_SRC[2], alt: 'Figure in a leather jacket', stackOffset: { x: -16, y: 0 }, stackRotate: -4,
    target: { x: -36, y: -2, rotate: 0, scale: SCALE[6], w: 15, h: 32 },
    targetSm: { x: -22, y: -19 }, z: 4 },
  { src: STACK_SRC[3], alt: 'Footballer mid-kick', stackOffset: { x: 1, y: -10 }, stackRotate: -2,
    target: { x: 6, y: -32, rotate: 0, scale: SCALE[5], w: 25, h: 30 },
    targetSm: { x: 22, y: -19 }, z: 5 },
  { src: STACK_SRC[4], alt: 'Terrier in profile', stackOffset: { x: 18, y: 1 }, stackRotate: 6,
    target: { x: 37, y: 6, rotate: 0, scale: SCALE[4], w: 18, h: 32 },
    targetSm: { x: -22, y: 20 }, z: 6 },
  { src: STACK_SRC[5], alt: 'Breakdancer holding a pose', stackOffset: { x: -6, y: 10 }, stackRotate: 6,
    target: { x: -24, y: 34, rotate: 0, scale: SCALE[3], w: 22, h: 25 },
    targetSm: { x: 22, y: 20 }, z: 7 },
  { src: STACK_SRC[6], alt: 'Renaissance fresco detail', stackOffset: { x: 8, y: 7 }, stackRotate: 3,
    target: { x: 2, y: 36, rotate: 0, scale: SCALE[2], w: 20, h: 26 },
    targetSm: { x: -22, y: 40 }, z: 8 },
  { src: STACK_SRC[7], alt: 'Vintage fighter plane', stackOffset: { x: 20, y: 12 }, stackRotate: -7,
    target: { x: 30, y: 34, rotate: 0, scale: SCALE[1], w: 16, h: 20 },
...
function SpreadCardFace({
  ...
  const restScale = scaleMul ?? card.target.scale ?? 1;
  ...
  return (
    <motion.div
      ...
      style={{
        width: `${fixedCard ? fixedCard.w : card.target.w}vw`,
        height: `${fixedCard ? fixedCard.h : card.target.h}vh`,
        zIndex: card.z ?? 1,
        translate,
        rotate,
        scale,
    ...
    >
      <div className="sticky top-0 h-screen w-full overflow-hidden">
        ...
        >
          ...
          >
            {subtitle ?? 'Embedded systems, hardware engineering, and AI-driven tools.'}
          </p>
        </motion.div>
